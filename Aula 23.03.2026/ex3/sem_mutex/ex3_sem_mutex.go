...
4. Compare o tempo de execução com e sem mutex
		Sem mutex: 721.7µs.
		Sem mutex, Com mutex, o acesso à variável compartilhada é sincronizado, garantindo o valor correto de 200000 em todas as execuções,
